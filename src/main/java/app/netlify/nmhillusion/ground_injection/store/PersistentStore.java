...
public class PersistentStore {
    ...
    private List<GroundModel> groundModelList = new ArrayList<>();
    ...
    public List<GroundModel> getGroundModelList() {
        return groundModelList;
    }

    public PersistentStore setGroundModelList(List<GroundModel> groundModelList) {
        this.groundModelList = groundModelList;
        return this;
    }
